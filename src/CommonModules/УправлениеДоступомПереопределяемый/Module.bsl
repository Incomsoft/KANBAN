...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
    ...
    ВидДоступа = ВидыДоступа.Добавить();
    ВидДоступа.Имя = "ГруппыПроектовКЗадачам"; // имя вида доступа (используется в ролях для RLS)
    ВидДоступа.Представление = НСтр("ru = 'Группы проектов к задачам'");
    ВидДоступа.ТипЗначений = Тип("СправочникСсылка.инкПроектыКЗадачам"); 
...
Процедура ПриЗаполненииИспользованияВидаДоступа(ВидДоступа, Использование) Экспорт
    ...
    Если ВидДоступа = "ГруппыПроектовКЗадачам" Тогда
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
    ...
    Описание = Описание + "
    |Задача.инкЗадачаПользователя.Чтение.ГруппыПроектовКЗадачам
    |Справочник.инкПроектыКЗадачам.Чтение.ГруппыПроектовКЗадачам
    |";
