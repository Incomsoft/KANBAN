...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура           = "инкОбновлениеИнформационнойБазыСервер.Обновление_1_0_1_17";
	Обработчик.РежимВыполнения     = "Монопольно";
	...
	Обработчик.Процедура           = "инкОбновлениеИнформационнойБазыСервер.Обновление_1_0_1_16";
	Обработчик.РежимВыполнения     = "Монопольно";
	Обработчик.НачальноеЗаполнение = Истина;       
	...
	Обработчик.Процедура           = "инкОбновлениеИнформационнойБазыСервер.Обновление_1_0_1_15";
	Обработчик.РежимВыполнения     = "Монопольно";
	Обработчик.НачальноеЗаполнение = Истина;       
	...
	Обработчик.Процедура           = "инкОбновлениеИнформационнойБазыСервер.Обновление_1_0_1_13";
	Обработчик.РежимВыполнения     = "Монопольно";
	Обработчик.НачальноеЗаполнение = Истина;       
	...
	Обработчик.Процедура           = "инкОбновлениеИнформационнойБазыСервер.Обновление_1_0_1_11";
	Обработчик.РежимВыполнения     = "Монопольно";
	Обработчик.НачальноеЗаполнение = Истина;       
...
Процедура ПриПодготовкеМакетаОписанияОбновлений(Макет) Экспорт
	...
	НомераВерсийДляОтображенияМассив.Добавить("1.0.1.18");
	НомераВерсийДляОтображенияМассив.Добавить("1.0.1.17");
	НомераВерсийДляОтображенияМассив.Добавить("1.0.1.16");
